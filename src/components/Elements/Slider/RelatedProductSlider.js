            ...
            <div className="shop-item text-center">
              <div className="shop-thumb">
                <Link href="/shop-details">
                  <a>
                    <img
                      src="/assets/img/products/product_img03.png"
                      alt="img not found"
                    />
                  </a>
                </Link>
              ...
              <div className="shop-item-content">
                <h6 className="title">
                  <Link href="/shop-details">
                    <a>Netbox Dual Whole Home Mesh TV Box System</a>
                  </Link>
                </h6>
                <h3 className="price">
                  <sup>$</sup>39.00
            ...
            <div className="shop-item text-center">
              <div className="shop-thumb">
                <Link href="/shop-details">
                  <a>
                    <img
                      src="/assets/img/products/product_img04.png"
                      alt="img not found"
                    />
                  </a>
                </Link>
              ...
              <div className="shop-item-content">
                <h6 className="title">
                  <Link href="/shop-details">
                    <a>Netbox Jabra PanaCast Virtual Video Conference</a>
                  </Link>
                </h6>
                <h3 className="price">
                  <sup>$</sup>85.00
            ...
            <div className="shop-item text-center">
              ...
              <div className="shop-thumb">
                <Link href="/shop-details">
                  <a>
                    <img
                      src="/assets/img/products/product_img05.png"
                      alt="img not found"
                    />
                  </a>
                </Link>
              ...
              <div className="shop-item-content">
                <h6 className="title">
                  <Link href="/shop-details">
                    <a>DigitalX DX-T2020 Hi-Fi 120W RMS Tower Speaker</a>
                  </Link>
                </h6>
                <h3 className="price">
                  <sup>$</sup>99.00
            ...
            <div className="shop-item text-center">
              <div className="shop-thumb">
                <Link href="/shop-details">
                  <a>
                    <img
                      src="/assets/img/products/product_img06.png"
                      alt="img not found"
                    />
                  </a>
                </Link>
              ...
              <div className="shop-item-content">
                <h6 className="title">
                  <Link href="/shop-details">
                    <a>Netbox Portable Wi-Fi White Clearance Router</a>
                  </Link>
                </h6>
                <h3 className="price">
                  <sup>$</sup>29.00
